...
export const About = () => {
  return (
    <section className="p-2 mt-[5rem] relative bg-sky-blue py-[5rem] z-[-1] overflow-hidden">
      <Container>
        <header>
        ...
        <div className="grid md:grid-cols-2 gap-[41px] mt-[50px]">
          ...
          <div className="text md:self-center">
            ...
            <a
              href="#!"
              className="resume-btn border-2 border-black rounded-[7px] text-[2.5rem] font-[500] inline-block mt-[36px] px-[44px] py-[10px] relative bg-white"
            >
              Resume
            </a>
          </div>
